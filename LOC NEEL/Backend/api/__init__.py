...
restServer.add_resource(verifyScholarship, "/api/v1/verifyScholarship/<string:sid>/<int:v_status>")
restServer.add_resource(verifyStudentProfile, "/api/v1/verifyStudentProfile/<string:uname>/<int:v_status>")
